...
export const StepChecklists = ({ checklistItems, updateChecklistItem, categories }: Props) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold mb-1">Checklists Operacionais</h2>
        <p className="text-sm text-muted-foreground">
          Verifique os itens inspecionados durante a manutenção
        </p>
      </div>
